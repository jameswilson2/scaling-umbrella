	...
	function getTableHeader(){
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="0" class="table">
			<tr class="rowstrong">
				...
				<td>Status</td>
				<td nowrap="nowrap">Approve or</td>
				<td>Reject</td>
			</tr>
EOD;
	...
	function renderRow($row){
		...
		switch ($comment_status){
			case 'pending':
				$status =  "<td><a href='comments/moderate.php?cid=$comment_id&amp;action=approve'>Approve</a></td><td><a href='comments/moderate.php?cid=$comment_id&amp;action=reject'>Reject</a></td>";
			break;

			case 'approved':
				$status =  "<td>&nbsp;</td><td><a href='comments/moderate.php?cid=$comment_id&amp;action=reject'>Reject</a></td>";
			break;

			case 'rejected':
				$status =   "<td><a href='comments/moderate.php?cid=$comment_id&amp;action=approve'>Approve</a></td><td>&nbsp;</td>";
			break;
		}

		$content_row = <<<EOD
		<tr class="row"><td><p>$comment_text</p></td>
			<td>$comment_name</td>
			<td width="160">$comment_datetime</td>
			<td>$comment_status_ucfirst</td>
			$status
		</tr>
EOD;
